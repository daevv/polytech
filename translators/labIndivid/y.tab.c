...
{
       0,   131,   131,   132,   135,   136,   138,   158,   189,   190,
     191,   192,   193,   194
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SEMI", "ID", "CONST",
  "AND", "OR", "NOT", "LPAREN", "RPAREN", "ASSIGN", "INT", "$accept",
  "lines", "line", "init", "assignment", "expression", YY_NULLPTR
};
...
{
      -2,    -8,     0,    13,    -2,   -14,   -14,     7,    16,   -14,
     -14,   -14,   -14,     7,     7,    11,   -14,   -14,    -1,   -14,
       7,     7,   -14,   -14,    14
};
...
{
      17,    18,     1,     7,     8,    20,    21,    23,    24,    22,
       2,    11,    12,     9,    19,    13,    14,    20,    21,    16,
      20,    10
};

static const yytype_int8 yycheck[] =
{
      13,    14,     4,    11,     4,     6,     7,    20,    21,    10,
      12,     4,     5,     0,     3,     8,     9,     6,     7,     3,
       6,     4
};
...
{
       0,     4,    12,    14,    15,    16,    17,    11,     4,     0,
      14,     4,     5,     8,     9,    18,     3,    18,    18,     3,
       6,     7,    10,    18,    18
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* init: INT ID SEMI  */
#line 138 "v1.y"
                  {  
	int i;
	for (i = 0; i < varCount; i++) {
    if (strcmp(variables[i].name, (yyvsp[-1].value)) == 0) {
	...
	if (i == varCount) {
      ...
      strcpy(variables[varCount].name, (yyvsp[-1].value));
      varCount++;
    } else {
...
#line 1279 "y.tab.c"
  ...
  case 7: /* assignment: ID ASSIGN expression SEMI  */
#line 158 "v1.y"
                                      {

	int i;
  for (i = 0; i < varCount; i++) {
    if (strcmp(variables[i].name, (yyvsp[-3].value)) == 0) {
      if (variables[i].initialized) {
        ...
        strcpy(variables[i].expression, (yyvsp[-1].value));
        strcpy(infix, (yyvsp[-1].value));
...
#line 192 "v1.y"
                                       { (yyval.value) = strcat(strcat((yyvsp[-2].value), (yyvsp[-1].value)), (yyvsp[0].value));}
#line 1338 "y.tab.c"
    break;
